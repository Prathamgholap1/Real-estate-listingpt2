...
<footer class="footer">
   ...
   <section class="flex">
      ...
      <div class="box">
         ...
         <a href="mailto:Prathamgholap9993@gmail.com"><i class="fas fa-envelope"></i><span>Prathamgholap9993@gmail.com</span></a>
   ...
   <div class="credit">&copy; copyright @ <?= date('Y'); ?> by <span>Pratham Gholap</span> | all rights reserved!</div>
