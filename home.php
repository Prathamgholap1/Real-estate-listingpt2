...
<section class="services">
   ...
   <div class="box">
         ...
         <h3>buy house</h3>
         <p>Find and purchase your dream home easily.</p>
      </div>

      <div class="box">
         <img src="images/icon-2.png" alt="">
         <h3>rent house</h3>
         <p>Explore rental properties that suit your needs.</p>
      </div>

      <div class="box">
         <img src="images/icon-3.png" alt="">
         <h3>sell house</h3>
         <p>Sell your property quickly at the best price.</p>
      </div>

      <div class="box">
         <img src="images/icon-4.png" alt="">
         <h3>flats and buildings</h3>
         <p>Browse apartments and commercial buildings for sale or rent.</p>
      </div>

      <div class="box">
         <img src="images/icon-5.png" alt="">
         <h3>shops and malls</h3>
         <p>Discover retail spaces and shopping centers for investment.</p>
      </div>

      <div class="box">
         <img src="images/icon-6.png" alt="">
         <h3>24/7 service</h3>
         <p>Get round-the-clock support for all your real estate needs.</p>
      </div>
